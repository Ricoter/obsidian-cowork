      ...
      <section>
        <div className="tw-space-y-4">
          ...
          <SettingItem
            type="slider"
            title="Max Sources"
            description="Cowork goes through your vault to find relevant notes and passes the top N to the LLM. Default for N is 30. Increase if you want more notes included in the answer generation step."
            min={1}
            max={128}
            step={1}
          ...
          {settings.enableSemanticSearchV3 && (
            <>
              ...
              <SettingItem
                ...
                description="Number of partitions for Cowork index. Default is 1. Increase if you have issues indexing large vaults. Warning: Changes require clearing and rebuilding the index!"
          ...
          <SettingItem
            type="switch"
            title="Enable Obsidian Sync for Cowork index"
          ...
          <SettingItem
            ...
            description="When enabled, Cowork index won't be loaded on mobile devices to save resources. Only chat mode will be available. Any existing index from desktop sync will be preserved. Uncheck to enable QA modes on mobile."
